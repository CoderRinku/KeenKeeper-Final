      ...
      <div className="flex flex-col md:flex-row gap-6 mt-6">
        ...
        <div className="w-full md:w-1/3">
          <div className="bg-white rounded-xl shadow-sm p-8 flex flex-col items-center text-center mb-4 border border-gray-100">
            ...
            <p className="text-gray-400 text-xs">Preferred: {friend.preferred_contact || "email"}</p>
          </div>
        ...
        <div className="w-full md:w-2/3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex flex-col items-center text-center">
              <h3 className="text-2xl font-bold text-[#214D38] mb-2">{friend.next_due || "Feb 27, 2026"}</h3>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <button 
                ...
                className="border border-gray-200 rounded-xl p-6 flex flex-col items-center gap-3 hover:shadow-md hover:border-[#214D38] transition text-gray-700"
              >
